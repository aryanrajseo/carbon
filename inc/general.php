...
function carbon_do_copyright()
{
    ...
    $credit_text = get_theme_mod('site_credits', $default_credits);
    $output = carbon_strip_p_tags($credit_text);

    $output = apply_filters('copyright-text_output', $output, '', $credit_text);
